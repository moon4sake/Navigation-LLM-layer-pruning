...
def main(args):
    ...
    def preprocess_function(examples):
        ...
        for question, a, b, c, d, answer in zip(examples['sent1'], examples['ending0'], examples['ending1'], examples['ending2'], examples['ending3'], examples['label']):
    ...
    dataset = load_dataset("datasets/GBaker--MedQA-USMLE-4-options-hf")
